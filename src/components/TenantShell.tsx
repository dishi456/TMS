...
const NAV: NavItem[] = [
  ...
  { href: "/tenant/marketplace", label: "Marketplace", icon: "bag" },
  { href: "/tenant/complaints", label: "Complaints", icon: "chat" },
  { href: "/tenant/messages", label: "Messages", icon: "messages" },
  { href: "/tenant/chat", label: "Property Chat", icon: "leasechat" },
  { href: "/tenant/lease", label: "Lease", icon: "doc" },
  { href: "/tenant/rental-history", label: "Rental History", icon: "history" },
          ...
          {NAV.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.href === "/tenant/chat" && propertyChatUnread > 0 && (
...
const icons = {
  ...
  leasechat: (<svg className={ic} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H8l-5 4z" /><path d="M8 9.5l4-2.5 4 2.5" /></svg>),
  ...
  history: (<svg className={ic} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v5h5" /><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8" /><path d="M12 7v5l4 2" /></svg>),
  bag: (<svg className={ic} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" /><path d="M3 6h18" /><path d="M16 10a4 4 0 0 1-8 0" /></svg>),
