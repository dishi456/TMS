  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500">A private conversation with your landlord for each lease.</p>
      </div>
      <ConversationList conversations={conversations} basePath="/tenant/chat" />
    </div>
  );
}
